...
<body class="fixed-navbar">
        ...
        <nav class="page-sidebar" id="sidebar">
            <div id="sidebar-collapse">
                ...
                <ul class="side-menu metismenu">
                    ...
                    {{-- Advertisement --}}
                    @if ($role == 'super-admin' || ($role == 'admin' && in_array('advertisement', $user_access)))
                        <li>
                            <a href="javascript:;">
                                <i class="sidebar-item-icon fa fa-sitemap"></i>
                    ...
                    @if ($role == 'super-admin' || ($role == 'admin' && in_array('employementsalarytype', $user_access)))
                        <li>
                            <a href="javascript:;">
                                <i class="sidebar-item-icon fa fa-sitemap"></i>
                                <span class="nav-label">salary type</span>
                                <i class="fa fa-angle-left arrow"></i>
                            </a>
                            <ul class="nav-2-level collapse">
                                <li>
                    ...
                    {{-- Title --}}
                    @if ($role == 'super-admin' || ($role == 'admin' && in_array('title', $user_access)))
                        <li>
                            <a href="javascript:;">
                                <i class="sidebar-item-icon fa fa-sitemap"></i>
                    ...
                    {{-- Jobseeker --}}
                    @if ($role == 'super-admin' || ($role == 'admin' && in_array('jobseeker', $user_access)))
                        <li>
                            <a href="javascript:;">
                                <i class="sidebar-item-icon fa fa-sitemap"></i>
                                <span class="nav-label">Jobseeker</span>
                                <i class="fa fa-angle-left arrow"></i>
                            </a>
                            <ul class="nav-2-level collapse">
                                <li>
                                    <a href="{{ route('admin.jobseeker.list') }}">
                                        <span class="fa fa-plus"></span>
                                        All lists
                                    </a>
                                </li>
                    ...
                    <li>
                     ...
                     {{-- emailsetting --}}
                     <li>
                        <a href="{{ route('emailsetting.index') }}"><i class="sidebar-item-icon fa fa-cog"></i>
                            <span class="nav-label">Email Setting</span></a>
                    </li>
                </ul>
            </div>
        </nav>
    ...
    <script src="{{ asset('/assets/admin/vendors/jvectormap/jquery-jvectormap-2.0.3.min.js') }}"
        type="text/javascript">
    </script>
    <script src="{{ asset('/assets/admin/vendors/jvectormap/jquery-jvectormap-world-mill-en.js') }}"
        type="text/javascript">
    </script>
    <script src="{{ asset('/assets/admin/vendors/jvectormap/jquery-jvectormap-us-aea-en.js') }}"
        type="text/javascript">
    </script>
    <!-- CORE SCRIPTS-->
    <script src="{{ asset('/assets/admin/js/app.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('/assets/admin/vendors/metisMenu/dist/metisMenu.min.js') }}" type="text/javascript">
    </script>
