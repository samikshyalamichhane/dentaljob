...
<x-admin-layout title="Create page">
    ...
    <div class="page-content fade-in-up">
        <form method="post" id="form" action="{{ route('page.store') }}" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="ibox">
                        ...
                        <div class="ibox-body" style="">
                            ...
                            <div class="form-group">
                                ...
                                <input id="files" class="form-control fileUpload" value="{{ old('image') }}" name="image"
                                    type="file">
                                        ...
                                        <div class="ibox-body">
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input class="form-control" type="text" value="{{ old('keyword') }}"
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <textarea name="meta_description" id="meta_description" maxlength="160" class="form-control" rows="8" placeholder="Enter Meta Description"
                                                    cols="80">{{ old('meta_description') }} </textarea>
                                                    <div id="seo_desc"></div>
                                            </div>
