<x-admin-layout title="All advertisements">
    <x-slot name="scripts">
    ...
    <div class="page-content fade-in-up">
        <div class="ibox">
            <div class="ibox-head">
                <div class="ibox-title">All advertisement</div>
                <div>
                    ...
                    <tbody>
                        ...
                        @forelse ($details as $key => $data)
                            <tr>
                                <td>{{ ++$key }}</td>
                                <td>{{ $data->title }}</td>
                                <td><img src="{{ asset('images/thumbnail/' . $data->image) }}" alt="image" height="100"
                                        width="100"></td>
                                <td>{{ $data->place }}</td>
                                ...
                                <td>
                                    ...
                                    <form class="adjust-delete-button"
                                        ...
                                        <button class="btn btn-danger btn-sm" type="submit" name="button"
                                            ...
                                            onclick="return confirm('Are you sure you want to delete this advertisement?')"><i
