    ...
    <div class="page-content fade-in-up">
        <div class="ibox">
            <div class="ibox-head">
                ...
                <div>
                    <a class="btn btn-info btn-md" href="{{ route('roleuser.create') }}">Add user</a>
                </div>
            </div>
                    ...
                    <tbody>
                        ...
                        @forelse ($details as $key => $data)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('roleuser.edit', $data->id) }}" class="btn btn-success btn-sm"><i
                                            class="fa fa-edit"></i></a>

                                    <form class="adjust-delete-button" action="{{ route('roleuser.destroy', $data->id) }}"
                                        method="post">
                                        @csrf
                                        @method('delete')
