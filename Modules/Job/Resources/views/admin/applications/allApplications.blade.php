<x-admin-layout title="All Applicant's name">
    <x-slot name="scripts">
                    ...
                    <tbody>
                        ...
                        @forelse ($details->applications as $key => $data)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.jobseeker.infos', $data->jobseeker->id) }}"
                                        class="btn btn-success btn-sm"><i class="fa fa-eye"></i></a>

                                    <a href="{{ route('admin.jobseeker.downloadcv', $data->jobseeker->id) }}"
